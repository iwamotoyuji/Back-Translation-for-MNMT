...
def parse_args():
    ...
    parser.add_argument('-p', '--pretrain', action='store_true', help="train init model")
    
    parser.add_argument('--adapt_init_MNMT', default=None, help="(experiment_name,epoch_cnt) you want to adapt")
    parser.add_argument('--adapt_prop_MNMT', default=None, help="(experiment_name,epoch_cnt) you want to adapt")
...
def main():
    ...
    if opt.adapt_prop_MNMT is not None:
        ...
        init_data = torch.load(init_path, map_location=lambda storage, loc: storage)
